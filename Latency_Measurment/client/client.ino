...
void mqttReconnect() {
    while (!client.connected()) 
    {
      ...
      {
        client.subscribe("1986191/window/callback");
...
void callback(char* topic, byte* message, unsigned int length) 
{
    ...
    Serial.println("Latency ms:");
    Serial.println( (int)((current_time - last_time) / 2.f) ); // RTT millis
}
...
void loop() 
{
    ...
    vTaskDelay(pdMS_TO_TICKS(10)); // Changed delay due to max port delay blocking the execution of the subscriber callback
}
