...
double ComputePeakFrequency_ESP()
{
    ...
    // Convert complex result to real/imaginary pair format
...
void ProcessingTask(void *parameter) 
{
    while (1) 
    {
        ...
        vTaskDelay(pdMS_TO_TICKS(1));  // Prevent watchdog reset - happening once per second without
    }
}
...
void MonitorTask(void *parameter) 
{
    while (1) 
    {
        ...
        vTaskDelay(pdMS_TO_TICKS(2000));  // Monitor every 2s
    }
}
